...
# the command to generate ld file from ld template
  add_custom_command(
    ...
    -x c # -x assembler-with-cpp don't work, it seems it's still compiled
    ${NOSYSDEF_CFLAG}
    -Hnocopyr
    ...
    ${linker_pass_define}
    ${LINKER_SCRIPT}
    -P # FIXME: the `#line' directives are left in ${linker_script_gen}
    -o ${linker_script_gen}
    VERBATIM
...
macro(toolchain_ld_baremetal)
  ...
  if(CONFIG_LINKER_ORPHAN_SECTION_WARN)
    message(WARNING "metaware toolchain does not support
           CONFIG_LINKER_ORPHAN_SECTION_WARN")
  elseif(CONFIG_LINKER_ORPHAN_SECTION_ERROR)
    zephyr_ld_options(
      ${LINKERFLAGPREFIX}-Xdisallow_orphan_sections)
  endif()
endmacro()
...
macro(toolchain_ld_base)
  ...
  if(CONFIG_LINKER_SORT_BY_ALIGNMENT)
    message(WARNING "metaware toolchain does not support
      CONFIG_LINKER_SORT_BY_ALIGNMENT")
  endif()
endmacro()

# generate ld script snippts from configure files
